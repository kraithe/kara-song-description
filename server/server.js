...
app.get('/loaderio-9f833ae01dd4e8b9f0da1f68d7295e00', (req, res) => {
  res.sendFile(path.join(__dirname, '../client/loaderio-9f833ae01dd4e8b9f0da1f68d7295e00.txt'));
...
function cache(req, res, next) {
  redisClient.get(req.params.songId, (err, cacheData) => {
...
app.get('/songDescription/:songId', cache, async(req, res) => {
  try {
    ...
    redisClient.setex(description.songId, 3600, JSON.stringify(description));
    res.status(200).send({
      success: true,
      data: description
    });
